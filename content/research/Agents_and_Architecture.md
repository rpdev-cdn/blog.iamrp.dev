...
* **Swarm Hub:** Return to the primary overview on [[research/index|Security & AI Research Index]].
...
* **Governance & Compliance:** Governed by [AI Augmentation for Users](https://iamrp.dev/Projects/Governance-and-Policies/AI_Augmentation_for_Users).
* **Master Credentials:** Review core competencies on [Curriculum Vitae & Master Resume](https://iamrp.dev/resume/master_resume).
* **Digital Garden Hub:** Return to the [iamrp.dev Executive Portfolio](https://iamrp.dev/).
...
```bibtex
@article{dissell2026agents,
  author    = {Dissell, Richard P.},
  title     = {Security Analysis and Research Agent: Multi-Agent Swarm Topology & Secure Execution Boundaries},
  journal   = {RPDev Autonomous Systems & Security Research Monographs},
  year      = {2026},
  url       = {https://blog.iamrp.dev/research/Agents_and_Architecture}
}
```
